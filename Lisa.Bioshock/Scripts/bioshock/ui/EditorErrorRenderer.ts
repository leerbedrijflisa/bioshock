class EditorErrorRenderer {

    public renderErrors(data: any, editor: CodeMirror.Editor): CodeMirror.LineWidget[] {
        ...
        for (var i in data) {
            ...
            if (data[i].Type == 2) {
                ...
                var marker = this.renderErrorMarker();
    ...
    private renderErrorMarker(): HTMLElement {
